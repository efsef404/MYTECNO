        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
                          <TableRow>
                            ...
                            <TableCell>申請希望日</TableCell>
                            <TableCell>申請者</TableCell>
                            <TableCell>部署</TableCell>
                            <TableCell>理由</TableCell>
                            <TableCell>特認</TableCell>
                            <TableCell>ステータス</TableCell>
                            <TableCell>処理者</TableCell>
                            <TableCell>処理日</TableCell>
                            {selectedTab === 'pending' && <TableCell align="right">アクション</TableCell>}
                          </TableRow>
                        </TableHead>
                      <TableBody>
                        {applications.map((app) => (
                          ...
                          >
                            <TableCell component="th" scope="row">{app.applicationDate ? dayjs(app.applicationDate).format('MM/DD HH:mm') : '-'}</TableCell>
                            <TableCell>{app.requestedDate ? dayjs(app.requestedDate).format('MM/DD') : '-'}</TableCell>
                            ...
                            <TableCell>{app.approverUsername ? `${app.approverUsername} (${app.approverDepartmentName || '部署なし'})` : '-'}</TableCell>
